...
**マッチさせたいテキスト**：マッチさせたいテキストには、ドロップさせたい音声ファイルに必ず含まれている要素を入れてください。基本的にはキャラクター名を入れてあげるのが良いと思います

例
1. 2026_結月ゆかり_こんにちは.wav の場合、 `_結月ゆかり_` 
2. 001_ずんだもん（ノーマル）_ずんだもんなのだ.wav の場合、 `_ずんだもん（ノーマル）_`
3. 00_小春六花_小春六花です の場合、 `_小春六花_`

※なおこのプラグインでの音声ファイルは wav形式のみに対応しています。出力する音声フィアルは必ず wavファイルで出力するようにしてください。
